...
function Result() {
  ...
  const { problems, isFinished, isLoaded, setProblems, setIsFinished } =
    useTriviaProvider();
  ...
  }, [problems, isFinished, isLoaded, navigate]);
  ...
  return (
    <div className='w-[500px] h-[800px] mx-auto rounded-lg bg-white ring-2 ring-indigo-600 px-4 py-10 text-center relative'>
      ...
      <div className='w-[calc(100%-32px)] absolute bottom-6'>
        <button
